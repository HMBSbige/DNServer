...
int main(int iArgCount, char** szaArgs)
{
	...
	{ &sAddr, DEFAULT_LISTEN_IP, DEFAULT_LISTEN_PORT, "listening", AI_PASSIVE }	//AI_PASSIVE for "getaddrinfo" as we use it for "bind"
	};
